...
def extract_iframe_and_code_pairs(tutorial_content: str) -> List[Tuple[str, str]]:
    ...
    while i < len(lines):
        ...
        if iframe_match:
            ...
            # Extract folder name from src like "./tutorial_force_graph_example/index.html?embedded=1"
...
def modify_code_for_generation(code: str, folder_name: str) -> str:
    ...
    Args:
        ...
        folder_name: Target folder name (e.g., "tutorial_force_graph_example")
    ...
    def replace_show_call(match):
        ...
        title = folder_name.replace("_", " ").replace("tutorial ", "").title()
...
def execute_code(code: str, folder_name: str) -> Tuple[bool, str, str]:
    ...
    try:
        ...
        return False, "", f"Timeout: Code execution took longer than 60 seconds"
...
def main():
    ...
    if not pairs:
        print("❌ No iframe/code pairs found in tutorial")
        sys.exit(1)
    ...
    if total - passed > 0:
        ...
        print(f"\n🎉 All {total} tutorial examples generated successfully!")
