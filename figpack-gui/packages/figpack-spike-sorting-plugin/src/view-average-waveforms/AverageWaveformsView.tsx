...
const AverageWaveformsView: FunctionComponent<Props> = ({
  ...
  const [waveformsMode, setWaveformsMode] = useState<"geom" | "vertical">(
    "geom",
  );
  ...
  const [showReferenceProbe, setShowReferenceProbe] = useState<boolean>(
    data.showReferenceProbe || false,
  );
      ...
      data.averageWaveforms
        ...
        .map((aw) => {
          ...
          }[] = [
            {
              ...
              waveformPercentiles:
                showWaveformStdev && !showOverlapping && aw.waveformPercentiles
                  ? subtractChannelMeansFromPercentiles(
                      aw.waveformPercentiles,
                      aw.waveform,
                    )
                  : undefined,
          ...
          const props: AverageWaveformPlotProps = {
            ...
            useUnitColors,
            width:
              120 * plotBoxScaleFactor +
              (showReferenceProbe ? (120 * plotBoxScaleFactor) / 4 : 0),
      ...
      >
        ...
        <VerticalScrollView width={0} height={0}>
          <PlotGrid
            ...
            selectedPlotKeys={
              !toolbarOptions.onlyShowSelected ? selectedUnitIds : undefined
            }
