...
import { createIframeMessageHandler } from '../../utils/postMessageUtils';
...
const UploadFilesPage: React.FC = () => {
  ...
  const [messageHandler] = useState(() => createIframeMessageHandler());
  ...
  useEffect(() => {
    messageHandler.onMessage('UPLOAD_REQUEST', handleUploadRequest);

    return () => {
      messageHandler.cleanup();
    };
  }, [messageHandler, handleUploadRequest]);
