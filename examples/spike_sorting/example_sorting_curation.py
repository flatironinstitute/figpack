...
def main():
    ...
    view = example_sorting_curation(recording=recording, sorting=sorting)
    title = "Example Sorting Curation"
    description_md = """
# Example Sorting Curation

This is an example of sorting curation created using figpack.
"""
...
def example_sorting_curation(*, recording, sorting) -> vv.Splitter:
