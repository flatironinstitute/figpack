...
export class PlaneSegmentationClient {
  ...
  static async create(zarrGroup: ZarrGroup) {
    ...
    return new PlaneSegmentationClient(zarrGroup, ids, imageMaskDataset, imageMaskRois);
  }
}

const loadImageMaskRois = async (ids: number[], imageMaskDataset: any): Promise<ImageMaskRoi[]> => {
